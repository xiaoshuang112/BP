...
#define num_node_input_BP	756//756//3780//784 //输入层节点数
#define width_image_BP		64//64//28 //归一化图像宽
#define height_image_BP		32//32//28 //归一化图像高
#define num_node_hidden_BP	160//160//120 //隐含层节点数
#define num_node_output_BP	3 //输出层节点数
...
#define iterations_BP		100   //10000 //最大训练次数
#define accuracy_rate_BP	0.88 //要求达到的准确率
	...
	public:
		...
		int VL_GetHOGFeature(int *pFeature, unsigned char* pSrc,int iW,int iH); //获取HOG特征
	...
	protected:
		...
		int  ReadFile(char *path, int* data_dst,int* Label_dst); 
